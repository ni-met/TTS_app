...
CREATE TABLE `cards` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci MAX_ROWS=3;
...
CREATE TABLE `reservations` (
  ...
  `dateOfReservation` time NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `trains` (
  ...
  `arrivingAt` varchar(45) NOT NULL,
...
CREATE TABLE `users` (
  `id` int NOT NULL AUTO_INCREMENT,
  `userIdNumber` varchar(45) NOT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`),
  UNIQUE KEY `userIdNumber_UNIQUE` (`userIdNumber`),
...
-- Dump completed on 2023-05-08  9:58:21
